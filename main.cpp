...
int main() {
    ...
    vector<pair<int, int>> arr1 = {{3, 1}, {2, 2}, {1, 3}, {2, 1}};
    ...
    cout << endl;
    stableSelectionSort(arr1);
    cout << "Sorted array by the first element:(stable selection sort)" << endl;
    for (const auto& p : arr1) {
        cout << "(" << p.first << ", " << p.second << ") ";
    }
    cout << endl;
